...
variable "prefix" {
  description = "Prefix for all the resources to be created. Only lowercase alphanumeric characters and hyphen"
  default     = "wordpress"
}

variable "site_domain" {
  description = "The primary domain name of the website (example.com)"
}
variable "public_alb_domain" {
  description = "The public domian name of the ALB (wp.example.com)"
}
